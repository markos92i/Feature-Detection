export class Matrix {
     ...
     */
    applyToArray(points: Array<any>): Array<any> {
        let i = 0, p, l;
        const mxPoints = [];
     ...
     */
    applyToTypedArray(points: any): Float32Array {
        let i = 0, p;
    ...
    decompose() {
        ...
        const skewX = Math.atan2(a * c + b * d, denom);
        return {
            ...
            translateX: e,                  // translation point  x
            translateY: f                   // translation point  y
        };
    }
